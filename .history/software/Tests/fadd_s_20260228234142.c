...
int test_fsw_storage2() {
    // 1. Load integer 5 into a register (li x15, 5)
    volatile int int_val1 = 5;
     volatile int int_val2 = 2;
    // 2. Convert to float (fcvt.s.w f10, x15)
    // This puts 5.0f (0x40a00000) into an FP register
    float f_val1 = (float)int_val1;
    //float f_val2 = (float)int_val2;

    //float f_result = f_val1 + f_val2; 
    int int_result = (int)f_val1;
...
int main(void) {
    int result1 = test_fsw_storage1();
    int result2 = test_fsw_storage2();
