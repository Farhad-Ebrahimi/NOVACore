...
TARGET_CFLAGS +=  -march=rv64imf_zicsr -march=rv64if -mno-div -Wall -Os -fomit-frame-pointer \
...
TARGET_LDFLAGS += -march=rv64imf_zicsr -march=rv64if -mno-div -nostartfiles -L../libsoc \
