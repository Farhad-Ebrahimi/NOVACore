...
TARGET_CFLAGS +=  -march=rv64imf_zicsr -mabi=lp64f -mno-div -Wall -Os -fomit-frame-pointer \
...
TARGET_LDFLAGS += -march=rv64imf_zicsr -mabi=lp64f -mno-div -nostartfiles -L../libsoc \
	-Wl,-m,elf64lriscv --specs=nosys.specs -Wl,--no-relax -Wl,--gc-sections
