...
frs1_to_be_convd <= rs1_forwarded when alu_op = ALU_FCVT_S_W or alu_op = ALU_FCVT_S_WU else '0';  --- 
rs1_to_frs1: entity work.pp_int_2_float
    port map(
        data_in => frs1_to_be_convd,
        alu_op_in => alu_op,
...
rs1_to_be_convd <= frs1_forwarded when alu_op = ALU_FCVT_W or alu_op = ALU_FCVT_WU else '0';  --- f
frs1_to_rs1: entity work.pp_float_2_int
    port map(
        frd_data_in => rs1_to_be_convd,
        alu_op_in => alu_op,
