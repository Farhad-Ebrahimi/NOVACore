...
begin
     ...
     begin
        if rising_edge(clk) then
            if reset = '1' then
                add_sign_in         <= (others => '0');
                add_exp_in          <= (others => '0');
                add_mant_in         <= (others => '0');
                add_rm_in           <= (others => '0');
                add_s1_valid_out_in <= '0';
                add_valid_in        <= '0';
                
                sub_sign_in         <= (others => '0');
                sub_exp_in          <= (others => '0');
                sub_mant_in         <= (others => '0');
                sub_rm_in           <= (others => '0');
                
                mul_product_in      <= (others => '0');
                mul_exp_sum_in      <= (others => '0');
                mul_sign_in         <= '0';
                mul_a_is_nan_in     <= '0';
                mul_b_is_nan_in     <= '0';
                mul_a_is_inf_in     <= '0';
                ...
                div_quotient_in     <= (others => '0');
                div_sticky_in       <= '0';
                div_exp_in          <= (others => '0');
                div_sign_in         <= '0';
                div_special_in      <= '0';
                div_special_result_in <= (others => '0');
                div_valid_in        <= '0';
                div_rm_in           <= (others => '0');
                div_busy_in         <= '0';
                div_s1_valid_out_in  <= '0';
            else
