...
begin
  ...
  ---raw_stall <= fp_raw_hazard or stall_exe_stg1 ;
...
detect_fp_raw_hazard : process (alu_op_to_stg3, alu_op_to_forwarding_stg3, frd_write_to_stg2, 
frd_addr_to_stg3, frd_write_to_forwarding_stg3, frd_addr_to_forwarding_stg3,frs1_addr, frs2_addr)
begin
fp_raw_hazard <= '0';
