...
architecture behaviour of fp_exe_stg1 is
  ...
  signal rs2_conv : std_logic_vector(31 downto 0);
  signal frs1_conv : std_logic_vector(31 downto 0);
  signal frs2_conv : std_logic_vector(31 downto 0);
  signal frd_data_out : std_logic_vector(31 downto 0);
...
begin
  ...
  -- FP comparisons (FEQ.S, FLT.S, FLE.S) write 0/1 result to integer register
    rd_data_out <= rs1_conv when (alu_op = ALU_FCVT_W or alu_op = ALU_FCVT_WU) 
           else frs1_forwarded when alu_op = ALU_FMVXW 
  ...
  frd_data_out <= rs1_forwarded when alu_op = ALU_FMVWX 
...
---rs2_to_frs2: entity work.pp_int_2_float
---    port map(
---        data_in => rs2_forwarded,
---        alu_op_in => alu_op,
---        frd_data_out => frs2_conv
---    );
...
--frs2_to_rs2: entity work.pp_float_2_int
--    port map(
--        frd_data_in => frs2_forwarded,
--        alu_op_in => alu_op,
--        rd_data_out => rs2_conv
--    );
