...
entity fpu_stage3 is
    port (
        ...
        start            : in  std_logic;
        en_fadd_in : in std_logic;
        en_fsub_in : in std_logic;
        en_fmul_in : in std_logic;
        en_fdiv_in : in std_logic;
    ...
    div_stage3 : entity work.ieee754_div_stage3
      ...
      begin
        if rising_edge(clk) then
            if reset = '1' then
                alu_op_reg <= ALU_NOP;
            elsif stall = '0' and ex_stall = '0' then
                alu_op_reg <= alu_op_in;
            end if;
        end if;
      end process;

process (alu_op_reg,add_result_int, add_flags_int, sub_result_int, sub_flags_int,
