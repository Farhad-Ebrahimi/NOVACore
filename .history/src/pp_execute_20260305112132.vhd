...
elsif ((if_fp_to_int_op(alu_op_in) and if_fp_arith_op(alu_op_to_stg3)) and (frs1_addr = frd_addr_to_stg3 and frd_write_to_stg3 = '1')) or 
((if_fp_to_int_op(alu_op_in) and if_fp_arith_op(alu_op_to_stg3)) and (frs2_addr = frd_addr_to_stg3 and frd_write_to_stg3 = '1')) then
