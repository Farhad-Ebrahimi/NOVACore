...
rm <= instruction_in(14 downto 12) when valid_in = '1' else "000";
  ...
  begin
    if rising_edge(clk) then
      ...
      if stall_exe_stg1 = '0' and internal_stall = '0' and fp_raw_hazard = '0' then   -----internal stall added, fp_raw_hazard gate added
...
fp_alu_x_forward : process (
    ...
    mem_op_to_stg3, mem_op_to_hazard_stg3)
begin

if frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs1_addr
   and mem_op_to_stg3 /= MEMOP_TYPE_LOAD_FP then
         frs1_forwarded <= frd_data_stg2_out;
elsif frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs1_addr
   and mem_op_to_hazard_stg3 /= MEMOP_TYPE_LOAD_FP then
...
if frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs2_addr
   and mem_op_to_stg3 /= MEMOP_TYPE_LOAD_FP then
         frs2_forwarded <= frd_data_stg2_out;

elsif frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs2_addr
   and mem_op_to_hazard_stg3 /= MEMOP_TYPE_LOAD_FP then
  ...
  begin
    ...
    (frd_addr_to_stg3 = frs1_addr or frd_addr_to_stg3 = frs2_addr) then
      load_hazard_detected <= '1';
    ...
    (frd_addr_to_forwarding_stg3 = frs1_addr or frd_addr_to_forwarding_stg3 = frs2_addr) then
    ...
    (mem_frd_addr = frs1_addr or mem_frd_addr = frs2_addr) then
