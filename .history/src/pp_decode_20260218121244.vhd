...
--	-- Extract register addresses from the instruction word:
	...
	---------For floating pont operations------------
		...
		-- Extract register addresses from the instruction word:
	frs1_addr <= instruction(19 downto 15) when instruction(6 downto 2) = b"10100" else 
	             instruction(19 downto 15) when (instruction(6 downto 2) = b"10100" and instruction(31 downto 25) = b"1111000") else  -- FMV.W.X: read from int rs1 as FP
	...
	frd_addr  <= instruction(11 downto  7) when instruction(6 downto 2) = b"10100" else 
	             instruction(11 downto 7) when (instruction(6 downto 2) = b"10100" and instruction(31 downto 25) = b"1111000") else  -- FMV.W.X: write to frd
	             (others => '0');   --destination register
	frd_addr_reg <= instruction(11 downto  7) when instruction(6 downto 2) = b"10100" else 
	                instruction(11 downto 7) when (instruction(6 downto 2) = b"10100" and instruction(31 downto 25) = b"1111000") else  
