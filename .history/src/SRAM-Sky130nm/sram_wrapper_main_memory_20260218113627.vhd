...
begin
    ...
    -- Initialization process: preload memory with FP test data during reset    
    ...
    begin
        if rising_edge(clk) then
            if rst = '1' then
                ...
                -- After reset, write initialization data to SRAM
                -- This allows the memory to be preinitialized in simulation
                init_done := '1';
            end if;
        end if;
