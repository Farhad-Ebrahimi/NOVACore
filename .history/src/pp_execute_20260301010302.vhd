...
fp_alu_x_forward : process (
  ...
  begin
    ...
    if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs1_addr   then
         frs1_forwarded <= rd_data_to_stg2;  --- fcvt is done in stgae2 and its result is written here so forwarding 
 ...
 begin
     -- if (stall_exe_stg1 ='0') then
        if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs2_addr   then
          frs2_forwarded <= rd_data_to_stg2;  --- fcvt is done in stgae2 and its result is written here
