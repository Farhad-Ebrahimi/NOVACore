...
-- Line 320-323, replace with:
fp_mem_addr <= std_logic_vector(
    unsigned(rs1_forwarded) + 
    -- Extract immediate directly from instruction for FLW/FSW
    unsigned((31 downto 12 => instruction_in(31)) & instruction_in(31 downto 20))
        when (instruction_in(6 downto 2) = b"00001") else  -- FLW: I-type
    unsigned((31 downto 12 => instruction_in(31)) & instruction_in(31 downto 25) & instruction_in(11 downto 7))
        when (instruction_in(6 downto 2) = b"01001") else  -- FSW: S-type
    (others => '0')  -- For integers, address calculated separately via ALU
);
