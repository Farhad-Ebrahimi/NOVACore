...
fp_alu_x_forward : process (
    alu_op_to_stg2, frd_write_to_stg2, frd_addr_to_stg2, rd_data_to_stg2,
    alu_op_to_stg3, alu_op_to_forwarding_stg3,
  ...
  begin
     ...
     -- EX2: non-fp-op (e.g. fcvt.s.w) result available in rd_data_to_stg2
     if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs1_addr and (not is_fp_op(alu_op_to_stg2)) then
          frs1_forwarded <= rd_data_to_stg2;
     --if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs1_addr  then
     --  frs1_forwarded <= rd_data_to_stg2;  -- FPU result from current Stage 3
      elsif frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs1_addr and (not is_fp_op(alu_op_to_stg3)) then
...
--    end if;                        
 ...
 begin
     -- EX2: non-fp-op (e.g. fcvt.s.w) result available in rd_data_to_stg2
     if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs2_addr and (not is_fp_op(alu_op_to_stg2)) then
          frs2_forwarded <= rd_data_to_stg2;
       --if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs2_addr  then
       --frs2_forwarded <= rd_data_to_stg2;  -- FPU result from current Stage 3
       elsif frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs2_addr and (not is_fp_op(alu_op_to_stg3)) then
