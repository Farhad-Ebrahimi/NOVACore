...
architecture behaviour of pp_fpu_register_file is
	...
	attribute mark_debug of frs1_addr  : signal is "true";
	attribute mark_debug of frs1_data  : signal is "true";
	attribute mark_debug of frs2_addr  : signal is "true";
	attribute mark_debug of frs2_data  : signal is "true";
	attribute mark_debug of frd_addr   : signal is "true";
	attribute mark_debug of frd_data   : signal is "true";
	attribute mark_debug of frd_write  : signal is "true";
begin
