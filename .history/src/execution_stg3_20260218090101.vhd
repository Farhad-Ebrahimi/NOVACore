...
begin
  ...
  dmem_address_out   <=  dmem_address when (mem_op = MEMOP_TYPE_LOAD_FP or mem_op = MEMOP_TYPE_STORE_FP) else
                         alu_result when (mem_op /= MEMOP_TYPE_NONE and mem_op /= MEMOP_TYPE_INVALID) and exception = '0'else dmem_address;
