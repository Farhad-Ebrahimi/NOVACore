...
architecture behaviour of fp_exe_stg2 is
 ...
 -- ADD Stage 1 outputs
    signal add_A_sign_in : std_logic;   ----from stg 1
    ...
    signal mul_A_frac_in : std_logic_vector(22 downto 0);  -- Raw fraction for NaN/Inf detection
  ...
  begin
    if rising_edge(clk) then
      if reset = '1' then
        ...
        add_A_sign_in <= add_A_sign_in;
        add_B_sign_in <= add_B_sign_in;
        add_A_exp_in <= add_A_exp_in;
        add_B_exp_in <= add_B_exp_in;
        add_A_mant_in <= add_A_mant_in;
        add_B_mant_in <= add_B_mant_in;
        add_rm_in <= add_rm_in;
        sub_A_sign_in <= sub_A_sign_in;
        sub_B_sign_in <= sub_B_sign_in;
        sub_A_exp_in <= sub_A_exp_in;
        sub_B_exp_in <= sub_B_exp_in;
        sub_A_mant_in <= sub_A_mant_in;
        sub_B_mant_in <= sub_B_mant_in;
        sub_rm_in <= sub_rm_in;
        mul_A_sign_in <= mul_A_sign_in;
        mul_B_sign_in <= mul_B_sign_in;
        mul_A_exp_in <= mul_A_exp_in;
        mul_B_exp_in <= mul_B_exp_in;
        mul_A_frac_in <= mul_A_frac_in;
        mul_B_frac_in <= mul_B_frac_in;
        mul_A_mant_in <= mul_A_mant_in;
        mul_B_mant_in <= mul_B_mant_in;
        mul_rm_in <= mul_rm_in;
        div_x_val_in <= div_x_val_in;
        div_y_val_in <= div_y_val_in;
        div_exp_in <= div_exp_in;
