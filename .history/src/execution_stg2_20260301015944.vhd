...
architecture behaviour of fp_exe_stg2 is
 ...
 -- ADD Stage 1 outputs
    ...
    signal sub_A_sign_in : in std_logic;
    signal sub_B_sign_in : in std_logic;
    signal sub_A_exp_in : in std_logic_vector(7 downto 0);
    signal sub_B_exp_in : in std_logic_vector(7 downto 0);
    signal sub_A_mant_in : in std_logic_vector(26 downto 0);
    signal sub_B_mant_in : in std_logic_vector(26 downto 0);
    signal sub_rm_in : in std_logic_vector(2 downto 0);
    signal 
    signal -- MUL Stage 1 outputs (including fractions)
    signal mul_A_sign_in : in std_logic;
    signal mul_B_sign_in : in std_logic;
    signal mul_A_exp_in : in std_logic_vector(7 downto 0);
    signal mul_B_exp_in : in std_logic_vector(7 downto 0);
    signal mul_A_frac_in : in std_logic_vector(22 downto 0);  -- Raw fraction for NaN/Inf detection
    signal mul_B_frac_in : in std_logic_vector(22 downto 0);
    signal mul_A_mant_in : in std_logic_vector(26 downto 0);
    signal mul_B_mant_in : in std_logic_vector(26 downto 0);
    signal mul_rm_in : in std_logic_vector(2 downto 0);
    signal 
    signal -- DIV Stage 1 outputs
    signal div_x_val_in : in std_logic_vector(31 downto 0);
    signal div_y_val_in : in std_logic_vector(31 downto 0);
