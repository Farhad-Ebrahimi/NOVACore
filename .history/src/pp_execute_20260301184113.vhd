...
raw_hazard_detect : process (
  ...
  begin
    ...
    -- EX3: forwarding (frd_data_stg3) is valid now — release stall
    ...
    -- EX2: FP result not ready yet, stall consumer at ID
    ...
    -- EX1: FP producer just entered EX1, stall consumer at ID immediately
