...
begin
	...
	stall_ex <= hazard_detected or stall_mem  or internal_stall; --- internal stall added. ---debug 2026-02-17
    ...
    begin
        if rising_edge(clk) then
            if reset = '1' then
                ...
                dmem_read_ack_r <= '1';  -- Always ready for testing (no real memory)
                dmem_write_ack_r  <= '1';  -- Always ready for testing (no real memory)
