...
begin
    ...
    if frd_write_to_stg3 = '1'
       and frd_addr_to_stg3 = frs1_addr then

        frs1_forwarded <= frd_data_stg3;

    elsif frd_write_to_forwarding_stg3 = '1'
       and frd_addr_to_forwarding_stg3 = frs1_addr then

        frs1_forwarded <= frd_data_stg3;

    elsif mem_frd_write = '1'
       and mem_frd_addr = frs1_addr then

        frs1_forwarded <= mem_frd_value;

    elsif wb_frd_write = '1'
       and wb_frd_addr = frs1_addr then
