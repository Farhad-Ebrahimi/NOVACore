      ...
      if reset = '1' then
       ...
       --- frd_data_out <= frd_data_in;   ---- for FPU
        ...
        dmem_read_req  <= dmem_read_req_in;
              ...
              mul_rm <= mul_rm_in;
              -- DIV Stage 2 inputs
              div_quotient_in <= div_quotient_in;
              div_sticky_in <= div_sticky_in;
              div_exp_in <= div_exp_in;
              div_sign_in <= div_sign_in;
              div_special_in <= div_special_in;
              div_special_result_in <= div_special_result_in;
              div_valid_in <= div_valid_in;
              div_rm_in <= div_rm_in;
              div_s1_valid_out <= div_s1_valid_out;
              div_busy        <= div_busy;
