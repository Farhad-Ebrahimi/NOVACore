...
elsif frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs1_addr then ----and (not is_fp_op(alu_op_to_stg3)) then
...
elsif frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs2_addr then  ----out of ex2
...
if ((if_fp_to_int_op(alu_op_in) and if_fp_arith_op(alu_op_to_stg2)) and (frs1_addr_in = frd_addr_to_stg2 and frd_write_to_stg2 = '1')) or ((if_fp_to_int_op(alu_op_in) and if_fp_arith_op(alu_op_to_stg2)) and (frs2_addr_in = frd_addr_to_stg2 and frd_write_to_stg2 = '1')) then
