...
fp_alu_x_forward : process (
  ...
  begin
     ...
     --  frs1_forwarded <= rd_data_to_stg2;  -- FPU result from current Stage 3
      ...
      elsif frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs1_addr and (not is_fp_op(alu_op_to_forwarding_stg3)) then  ---and (not is_fp_op(alu_op_to_forwarding_stg3))
 ...
 begin
     -- if (stall_exe_stg1 ='0') then
       ...
       if frd_write_to_stg3 = '1' and frd_addr_to_stg3 = frs2_addr and (not is_fp_op(alu_op_to_stg3)) then
        ...
        elsif frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs2_addr and (not is_fp_op(alu_op_to_forwarding_stg3))  then  ---and (not is_fp_op(alu_op_to_forwarding_stg3)) 
  ...
  detect_load_hazard : process (
    ...
    rs1_addr,frs1_addr, rs2_addr, frs2_addr, alu_x_src, alu_y_src,alu_op_to_stg3, frd_write_to_stg3)
  begin
