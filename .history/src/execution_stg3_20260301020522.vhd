...
-- FPU Stage 2 all 4 operations inputs (for final muxing by funct7)
    -- ADD Stage 2 inputs
    signal add_sign_in : in std_logic;
    signal add_exp_in : in std_logic_vector(7 downto 0);
    signal add_mant_in : in std_logic_vector(27 downto 0);
    signal add_rm_in : in std_logic_vector(2 downto 0);
    signal add_valid_in : in std_logic;
    signal add_s1_valid_out : in  std_logic;  ---- coming from stage2
     -- SUB Stage 2 inputs
    signal sub_sign_in : in std_logic;
    signal sub_exp_in : in std_logic_vector(7 downto 0);
    signal sub_mant_in : in std_logic_vector(27 downto 0);
    signal sub_rm_in : in std_logic_vector(2 downto 0);
     
    signal -- MUL Stage 2 inputs
    signal mul_product_in : in std_logic_vector(47 downto 0);
    signal mul_exp_sum_in : in std_logic_vector(7 downto 0);
    signal mul_sign_in : in std_logic;
    signal mul_a_is_nan : in std_logic;
    signal mul_b_is_nan : in std_logic;
    signal mul_a_is_inf : in std_logic;
    signal mul_b_is_inf : in std_logic;
    signal mul_a_is_zero : in std_logic;
    signal mul_b_is_zero : in std_logic;
    signal mul_rm_in : in std_logic_vector(2 downto 0);
    
    signal -- DIV Stage 2 inputs
    signal div_quotient_in : in std_logic_vector(31 downto 0);
    signal div_sticky_in : in std_logic;
    signal div_exp_in : in std_logic_vector(7 downto 0);
    signal div_sign_in : in std_logic;
    signal div_special_in : in std_logic;
    signal div_special_result_in : in std_logic_vector(31 downto 0);
    signal div_valid_in : in std_logic;
    signal div_rm_in : in std_logic_vector(2 downto 0);
    signal div_s1_valid_out : in  std_logic;  ---- coming from stage2
    signal div_busy        : in  std_logic;
     
    signal instruction_in : in std_logic_vector(31 downto 0);  -- For funct7
