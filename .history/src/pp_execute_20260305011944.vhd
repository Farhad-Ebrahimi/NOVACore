...
--elsif (if_fp_to_int_op(alu_op_in) and if_fp_op(alu_op_to_forwarding_stg3)) and (frs1_addr_in = frd_addr_to_forwarding_stg3 and frd_write_to_forwarding_stg3 = '1') then
--
--  fp_raw_hazard <= '1';
--
--elsif (if_fp_to_int_op(alu_op_in) and if_fp_op(alu_op_to_forwarding_stg3)) and (frs2_addr_in = frd_addr_to_forwarding_stg3 and frd_write_to_forwarding_stg3 = '1') then
--
--  fp_raw_hazard <= '1';
else 
  fp_raw_hazard <= '0';
