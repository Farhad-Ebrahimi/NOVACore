...
architecture behaviour of fp_exe_stg1 is
  ...
  signal rs1_conv : std_logic_vector(31 downto 0);
...
rs2_to_frs2: entity work.pp_int_2_float
    port map(
        ...
        alu_op_in => alu_op,
        frd_data_out => frs2_forwarded
    );


frs1_to_rs1: entity work.pp_float_2_int
    port map(
        data_in => frs1_forwarded,
        alu_op_in => alu_op,
        rd_data_out => rs1_forwarded
    );

frs2_to_rs2: entity work.pp_float_2_int
    port map(
        data_in => frs2_forwarded,
        alu_op_in => alu_op,
        rd_data_out => rs2_forwarded
    );
