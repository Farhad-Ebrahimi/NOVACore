...
architecture behaviour of fp_exe_stg2 is
 ...
 -- ADD Stage 1 outputs
    	signal add_A_sign    : std_logic;   ----from stg 1
    signal add_B_sign    : std_logic;
    signal add_A_exp    : std_logic_vector(7 downto 0);
    signal add_B_exp    : std_logic_vector(7 downto 0);
    signal add_A_mant    : std_logic_vector(26 downto 0);
    signal add_B_mant    : std_logic_vector(26 downto 0);
    signal add_rm    : std_logic_vector(2 downto 0);
    signal add_valid : std_logic;
    -- SUB Stage 1 outputs
    signal sub_A_sign    :  std_logic;
    signal sub_B_sign    :  std_logic;
    signal sub_A_exp    : std_logic_vector(7 downto 0);
    signal sub_B_exp    : std_logic_vector(7 downto 0);
    signal sub_A_mant    : std_logic_vector(26 downto 0);
    signal sub_B_mant    : std_logic_vector(26 downto 0);
    signal sub_rm    : std_logic_vector(2 downto 0);
    
    --signal -- MUL Stage 1 outputs (including fractions)
    signal mul_A_sign    : std_logic;
    signal mul_B_sign    : std_logic;
    signal mul_A_exp    : std_logic_vector(7 downto 0);
    signal mul_B_exp    : std_logic_vector(7 downto 0);
    signal mul_A_frac    : std_logic_vector(22 downto 0);  -- Raw fraction for NaN/Inf detection
    signal mul_B_frac    : std_logic_vector(22 downto 0);
    signal mul_A_mant    : std_logic_vector(26 downto 0);
    signal mul_B_mant    : std_logic_vector(26 downto 0);
    signal mul_rm    : std_logic_vector(2 downto 0);
     
    --signal -- DIV Stage 1 outputs
    signal div_x_val    : std_logic_vector(31 downto 0);
    signal div_y_val    : std_logic_vector(31 downto 0);
...
begin
  ...
  fpu_stg2_instance : entity work.fpu_stage2
    port map(
      ...
      add_A_sign => add_A_sign,
      add_B_sign => add_B_sign  ,
      add_A_exp => add_A_exp  ,
      add_B_exp => add_B_exp  ,
      add_A_mant => add_A_mant  ,
      add_B_mant => add_B_mant  ,
      add_rm => add_rm  ,
      add_valid => add_valid  ,  ---need to declare add_valid  
      ...
      -- SUB Stage 1 inputs
      sub_A_sign => sub_A_sign,
      sub_B_sign => sub_B_sign,
      sub_A_exp => sub_A_exp,
      sub_B_exp => sub_B_exp,
      sub_A_mant => sub_A_mant,
      sub_B_mant => sub_B_mant,
      sub_rm => sub_rm,
      ...
      div_valid => div_valid,    ----from s1 to s2
      div_rm_in           => div_rm,
