...
raw_hazard_detect : process (
  ...
  begin
    ...
    -- FP arithmetic at EX2: consumer at ID needs 2 stall cycles
    if is_fp_op(alu_op_to_stg2) and frd_write_to_stg2 = '1'
      and (frd_addr_to_stg2 = frs1_addr_in or frd_addr_to_stg2 = frs2_addr_in) then
      fp_raw_hazard_detected <= '1';

    -- FP arithmetic at EX3: consumer at ID needs 1 stall cycle
    elsif is_fp_op(alu_op_to_stg3) and frd_write_to_stg3 = '1'
...
DELETE_OLD_BODY : process (alu_op_to_stg3)
