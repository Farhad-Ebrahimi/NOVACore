...
--    end if;                        
 ...
 begin
  ...
  begin
    ...
    -- EX3: forwarding via frd_data_stg3 is now valid — release stall
    ...
    -- EX2: FP result not ready yet, hold consumer at ID
    ...
    -- EX1: FP producer just entered EX1, hold consumer at ID immediately
 ...
 (RAW) due to CSD Arithme operations ->IE1/->IE3
