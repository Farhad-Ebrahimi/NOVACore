...
---------jump not for floats
  ...
  alu_x <= alu_x_mux_o when (stall ='0' and internal_stall = '0' and raw_stall = '0') else alu_x_reg;   -------internal stall added
  alu_y <= alu_y_mux_o when (stall ='0' and internal_stall = '0' and raw_stall = '0') else alu_y_reg;   -------internal stall added
  ...
  begin
    if rising_edge(clk) then
      ...
      elsif stall = '1' or internal_stall = '1' or raw_stall = '1' then
        csr_write <= CSR_WRITE_NONE;
        ----frd_write_out <= '0'; 
      elsif stall = '0' and internal_stall = '0' and raw_stall = '0' then   ---or internal_stall = '0'
