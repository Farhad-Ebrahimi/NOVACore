...
-- --     frs1_forwarded <= frd_stg1_result;
if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs1_addr and (not is_fp_op(alu_op)) then
      frs1_forwarded <= rd_data_to_stg2;  ----out of stage1 to stage3
...
---     frs2_forwarded <= frd_stg1_result;
...
--
if frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs2_addr and (not is_fp_op(alu_op_to_forwarding_stg3)) then
