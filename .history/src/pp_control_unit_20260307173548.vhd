...
begin
	...
	decode_ctrl: process(opcode, funct3, funct12 , funct7,rs2)
	begin
		...
		case opcode is
			...
			when b"10100" => -- Opcode 0x53 (Floating-point) ------dec-2025
			    case funct7 is
					when b"0000000" | b"0000100" | b"0001000" | b"0001100" | b"1111000" | b"1101000" =>  --add,sub,mul,div, fmv.w.x,fcvt.sw,fcvt.s.wu write to frs
    					frd_write <= '1';
    					exception <= '0';
						rd_write  <= '0';
