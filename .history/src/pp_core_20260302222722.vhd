...
---------------------------------need to check the stall for csr read address------------------------
	...
	frs1_address <= id_frs1_address when stall_fpu = '0' else --and stall_ex = '0' else
		frs1_address_p;
	frs2_address <= id_frs2_address when stall_fpu = '0' else ---and stall_ex = '0'  else
		frs2_address_p;
	...
	store_previous_frsaddr : process (clk, stall_fpu,stall_ex)
		begin
		if rising_edge(clk) and stall_fpu = '0' else ---and stall_ex = '0' then  ---and fpu_stall_active = '0'
