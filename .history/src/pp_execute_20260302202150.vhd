...
if frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs1_addr and (not is_fp_op(alu_op_to_forwarding_stg3)) then  --- forwading from stage3 to stage1
