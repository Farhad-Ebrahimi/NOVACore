...
--    end if;                        
 ...
 begin
  ...
  begin
    ...
    -----or mem_op_to_stg3 = MEMOP_TYPE_LOAD_FP  or (frd_addr_to_stg3 = frs1_addr) 
...
-----or mem_op_to_hazard_stg3 = MEMOP_TYPE_LOAD_FP or (frd_addr_to_forwarding_stg3 = frs1_addr ) or (frd_addr_to_forwarding_stg3 = frs2_addr ))
      ...
      ---or mem_mem_op = MEMOP_TYPE_LOAD or (mem_frd_addr = frs1_addr )or (mem_frd_addr = frs2_addr )
