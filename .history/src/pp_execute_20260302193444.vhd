...
--if frd_write_to_stg2 = '1' and frd_addr_to_stg2 = frs1_addr and (not is_fp_op(alu_op_in)) then
--       frs1_forwarded <= frd_data_stg2_out;
----
  if frd_write_to_forwarding_stg3 = '1' and frd_addr_to_forwarding_stg3 = frs1_addr then  --- forwading from stage3 to stage1
