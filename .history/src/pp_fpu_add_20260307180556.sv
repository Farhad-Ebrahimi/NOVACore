...
module ieee754_adder_stage3 (
    ...
    always_comb begin
        ...
        // Flags
        flags[4] = (norm_exp == 8'hFF) && (norm_mant[25:3] != 23'd0); // NV
        flags[3] = 1'b0; // DZ (not applicable)
        flags[2] = (result_temp[30:23] == 8'hFF) && (result_temp[22:0] == 23'd0); // OF
        flags[1] = (result_temp[30:23] == 8'd0) && (result_temp[22:0] != 23'd0); // UF
        flags[0] = guard | round | sticky; // NX
    end
