...
architecture behaviour of pp_writeback is
	...
	attribute mark_debug of rd_addr_in    : signal is "true";
	attribute mark_debug of rd_data_in    : signal is "true";
	attribute mark_debug of rd_write_in   : signal is "true";
	attribute mark_debug of frd_addr_in   : signal is "true";
	attribute mark_debug of frd_data_in   : signal is "true";
	attribute mark_debug of frd_write_in  : signal is "true";
begin
	...
	begin
		if rising_edge(clk) then
			if reset = '1' then
			    ...
			    if stall = '0' then   --- intenal stall will stay low for ints 
