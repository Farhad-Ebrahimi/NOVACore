...
-- FPU Stage 2 all 4 operations inputs (for final muxing by funct7)
    ...
    signal mul_a_is_nan :  std_logic;
    signal mul_b_is_nan :  std_logic;
    signal mul_a_is_inf :  std_logic;
    signal mul_b_is_inf :  std_logic;
    signal mul_a_is_zero :  std_logic;
    signal mul_b_is_zero :  std_logic;
