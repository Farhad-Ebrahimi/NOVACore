...
architecture rtl of nv_memsys is
    ...
    signal last_read_addr : std_logic_vector(31 downto 0);
    signal last_write_addr : std_logic_vector(31 downto 0);
...
begin
    ...
    arbiter_inst : entity work.nv_arbiter
        port map(
            ...
            mem_read_ack => mem_read_ack_pending,
